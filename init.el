...
(use-package emacs
  ...
  (;; Exit Emacs!
   ...
   ("C-M-<kp-up>" . enlarge-window)
   ("C-M-<down>" . shrink-window)
   ("C-M-<kp-down>" . shrink-window)
   ("C-M-<left>" . shrink-window-horizontally)
   ("C-M-<kp-left>" . shrink-window-horizontally)
   ("C-M-<right>" . enlarge-window-horizontally)
   ("C-M-<kp-right>" . enlarge-window-horizontally)
   ("C-<kp-begin>" . balance-windows)
   ("C-M-<kp-begin>" . rh-balance-windows-horizontally)
   ("C-M-S-<kp-begin>" . rh-balance-windows-vertically))
