(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-tailwindcss lsp-pyright lsp-mode go-mode hl-column rust-mode blacken forge-worktree magit-worktree elfmt elisp-autofmt emacs-elisp-autofmt spell-fu flycheck-aspell cmake-mode git-timemachine csharp-mode auctex prettier tree-sitter-langs tree-sitter bazel-mode bazel flatbuffers-mode elf-mode protobuf-mode eglot lsp ghub dired-mode-map compile-eslint rh-bs gnu-elpa-keyring-update company-c-headers github-review forge beacon eval-sexp-fu scss-mode lispy dumb-jump ivy-rich rainbow-mode company-quickhelp company-tern tern counsel markdown-mode amx color-theme-sanityinc-tomorrow json-mode flycheck-popup-tip fill-column-indicator fci-mode findr ivy-hydra counsel-ag wgrep iedit realgud js2-refactor test-simple list-utils bm com-css-sort graphql-mode total-lines use-package-ensure-system-package unicode-fonts elisp-slime-nav delight diminish ace-window avy pcre2el flycheck-pos-tip smart-mode-line iflipb yasnippet-snippets typescript-mode flycheck company tide htmlize clang-format modern-cpp-font-lock which-key undo-tree google-c-style picture-mode nlinum-hl magit hlinum highlight-indent-guides nlinum ac-html web-mode async visual-regexp popwin sr-speedbar gdb-mix web-beautify ac-js2 skewer-mode moz js2-mode pos-tip fuzzy auto-complete paradox flx-ido use-package))
