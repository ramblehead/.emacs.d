...
(custom-set-faces
 ...
 '(term-color-black ((t (:background "#767875" :foreground "#2E3436"))))
 '(term-color-blue ((t (:background "#88AACF" :foreground "#3465A4"))))
 '(term-color-cyan ((t (:background "#34E2E2" :foreground "#06989A"))))
 '(term-color-green ((t (:background "#94C368" :foreground "#7FF110"))))
 '(term-color-magenta ((t (:background "#C497BF" :foreground "#A177A8"))))
 '(term-color-red ((t (:background "light coral" :foreground "IndianRed1"))))
 '(term-color-white ((t (:background "#EEEEEC" :foreground "#D3D7CF"))))
 '(term-color-yellow ((t (:background "#FCE94F" :foreground "#D3AC00"))))
 '(vterm-color-default ((t (:inherit default :background "black" :foreground "white"))))
 '(vterm-color-inverse-video ((t (:inherit vterm-color-default :background "dim gray"))))
