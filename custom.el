...
(custom-set-faces
 ...
 '(term-color-blue ((t (:background "midnight blue" :foreground "midnight blue"))))
 '(term-color-cyan ((t (:background "cornflower blue" :foreground "cornflower blue"))))
 '(term-color-magenta ((t (:background "plum" :foreground "plum"))))
